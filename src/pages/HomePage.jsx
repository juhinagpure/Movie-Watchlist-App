  ...
  return (
    <div className="flex">
      <div
        ...
        } transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 lg:w-1/6 bg-slate-100 p-4 min-h-screen`}
      >
      ...
      <div className="flex flex-col items-center px-10 pt-10 w-full lg:w-5/6 lg:ml-auto">
        <header className="w-full">
          <button
            className="text-blue-600 lg:hidden mb-10"
          ...
          <div className=" mt-10 w-full">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {recentMovies.map((movie) => (
                <div
                  key={movie.imdbID}
                  className="w-1/3 md:w-1/5 p-2 cursor-pointer"
