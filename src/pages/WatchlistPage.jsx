      ...
      {watchlistMovies.length > 0 ? (
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {watchlistMovies.map((movie) => (
            <div key={movie.imdbID} className="cursor-pointer bg-gray-100 rounded p-2 shadow-md flex flex-col items-center" onClick={() => navigate(`/movie/${movie.imdbID}`)}>
              <img src={movie.Poster} alt={movie.Title} className="mb-2 aspect-[3/4]" />
